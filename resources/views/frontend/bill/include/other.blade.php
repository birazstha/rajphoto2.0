<form action="{{ route('other-incomes.store') }}" method="POST" autocomplete="off">
    ...
    <div class="row">
        <div class="col-4">
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <td><input type="number" name="rate" value=""
                            id="other_rate" class="form-control">
                    </td>
                </div>
            </div>
        </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <td><input type="number" name="quantity" value="1"
                            id="other_quantity" class="form-control" {{ isset($item) ? 'readonly' : '' }} required>
                    </td>
                </div>
            </div>
            @error('paid_amount')
        ...
        <div class="col-4">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <td><input type="text" name="total" id="other_total" value="{{ $item->due_amount ?? '' }}"
    ...
    <div class="row">
        ...
        <input type="text" hidden name="date" class="order-date" value="">
    </div>
