        ...
        <div class="header-content clearfix">
            <div class="header-left clearfix pull-left">
                <h1 class="pull-left logo-tag">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('public/uploads/config/') }}/{{ getCmsConfig('cms logo') }}" alt="Ek logo"
                            height="20">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item dropdown header-user">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropDown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="header-avatar js-lazy-loaded" src="{{ asset('public/images/avatar.png') }}"
                                width="23" height="23" alt="profile">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropDown">
                            <div class="li-user dropdown-item">
                                <h2>{{ Auth::user()->name ?? '' }}</h2>
                                <p>{{ Auth::user() ? Auth::user()->username ?? '' : '' }}({{ getRoleCache(authUser())->name ?? '' }})
                                </p>
                            </div>
