...
@section('inputs')
    ...
    <x-system.form.form-group :input="[
        ...
        'label' => 'Username',
        'required' => true,
        'default' => $item->username ?? old('username'),
    ...
    <x-system.form.form-group :input="['name' => 'role_id', 'label' => 'Role', 'required' => true]">
        <x-slot name="inputs">
            <x-system.form.input-select :input="[
                ...
                'label' => 'Role',
                'required' => true,
                'default' => $item->role_id ?? old('role_id'),
                'options' => $roles,
        ...
        <x-system.form.form-group :input="['name' => 'set_password_status', 'label' => 'Set Password ?', 'required' => true]">
            <x-slot name="inputs">
                <x-system.form.input-radio :input="[
                    ...
                    'label' => 'Set Password',
                    'required' => true,
                    'default' => old('set_password_status') ?? 0,
                    'options' => [
                        ['value' => '0', 'label' => 'Send Activation Link'],
                        ['value' => '1', 'label' => 'Set Password'],
                    ],
                ]" />
            </x-slot>
        </x-system.form.form-group>
